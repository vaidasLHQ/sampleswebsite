...
// VERSION 15 - 50/50 Split Layout with Full Titles
// Changes from V12:
// - 50% Hero Left / 50% Sample Browser Right (was 60/40)
// - Full sample titles visible (no truncation)
